...
function App() {
  return (
    <Routes>
      ...
      <Route path="/sangyeon" element={<MemberPage profile={sangyeonProfile} name='Sangyeon Byeon' email='jiakang@gachon.ac.kr' github='ideawolf' githubLink='https://github.com/ideawolf' phone='010-5432-1279' role='infrastructure' birth='2000.03.16' mbti='INTP' address='경기도 성남시' />} />
